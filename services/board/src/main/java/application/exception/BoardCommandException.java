...
public class BoardCommandException extends CustomException {
    ...
    public BoardCommandException(ErrorCode errorCode, java.util.function.Supplier<java.util.Map<String, Object>> payload) {
        super(errorCode, payload);
    }

    public BoardCommandException(ErrorCode errorCode, java.util.function.Supplier<java.util.Map<String, Object>> payload, Throwable cause) {
