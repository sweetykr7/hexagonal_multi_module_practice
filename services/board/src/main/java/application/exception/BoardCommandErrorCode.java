...
public enum BoardCommandErrorCode implements ErrorCode {
    ...
    @Override
    public RuntimeException exception(java.util.function.Supplier<java.util.Map<String, Object>> payload) {
        return new BoardCommandException(this, payload);
    }

    @Override
    public RuntimeException exception(java.util.function.Supplier<java.util.Map<String, Object>> payload, Throwable cause) {
